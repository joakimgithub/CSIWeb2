angular.module('myApp.customerCrudView', ['ngRoute', 'ui.bootstrap'])

    .config(['$routeProvider', function ($routeProvider) {
        'use strict';
        $routeProvider.when('/customerCrudView/:id?', {
    ...
    .controller('customerController', ['$scope', '$route', '$location', 'customerFactory', 'modalService', '$routeParams',
                                  function PostController($scope, $route, $location, customerFactory, modalService, $routeParams) {
            'use strict';
